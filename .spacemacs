...
before packages are loaded."
  ...
  ;; Support ligature font
  (mac-auto-operator-composition-mode)

  ;; Use theme all-the-icons for neotree
  ...
  ;; Config for cursor state in term
